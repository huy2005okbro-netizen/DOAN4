...
export default function DangNhapKhachHang() {
  ...
  const validate = () => {
    ...
    if (!form.email.trim()) e.email = "Email hoặc số điện thoại là bắt buộc";
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.role !== "CUSTOMER") {
        setServerError("Tài khoản không phải khách hàng");
        return;
      }
      login(data.token, {
        id: data.userId,
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 400 }}>
          ...
          <div className="auth-card">
            ...
            <div className="auth-header">
              ...
              <h1 className="auth-title">Đăng nhập Khách hàng</h1>
              <p className="auth-subtitle">Trải nghiệm dịch vụ tuyệt vời</p>
            </div>
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="auth-row">
                ...
                <button
                  ...
                  onClick={() => navigate("/customer/quen-mat-khau")}
                >
                  Quên mật khẩu?
                </button>
              </div>
              ...
              <p className="auth-register-link">
                Chưa có tài khoản?{" "}
                <Link to="/customer/dang-ky">Đăng ký ngay</Link>
              </p>
            </form>
          </div>

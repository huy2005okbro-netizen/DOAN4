...
export default function DangNhapNhanVien() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.role !== "EMPLOYEE") {
        setServerError("Tài khoản không có quyền Nhân viên");
        return;
      }
      login(data.token, {
        id: data.userId,
        ...
        <div style={{ position: "relative", width: "100%", maxWidth: 400 }}>
          ...
          <div className="auth-card">
            ...
            <div className="auth-header">
              <div className="auth-avatar auth-avatar--employee">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                  ...
                  <path
                    ...
                    strokeLinecap="round"
                  />
                  <circle cx="19" cy="7" r="3" fill="rgba(255,255,255,0.7)" />
                  <path
                    d="M22 21v-1.5a3.5 3.5 0 0 0-2-3.15"
              ...
              <h1 className="auth-title">Đăng nhập Nhân viên</h1>
              <p className="auth-subtitle">Đăng nhập để phục vụ khách hàng</p>
            </div>
            ...
            <form className="auth-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="auth-field">
                <label className="auth-label">Mã nhân viên / Email</label>
              ...
              <div className="auth-row">
                ...
                <button
                  ...
                  onClick={() => navigate("/employee/quen-mat-khau")}
                >
                  Quên mật khẩu?
                </button>
              </div>
